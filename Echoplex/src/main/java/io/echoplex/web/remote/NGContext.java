 ...
 * specifically written for NailGun. The <a href="CommandServer.html">NailGun server</a> itself, its
...
public class NGContext {
	...
	/**
	 * The CommandServer that accepted this connection
	 */
	...
	public void setNGServer(CommandServer server) {
		this.server = server;
	}
	...
	/**
	 * Returns the CommandServer that accepted this connection
	 * @return the CommandServer that accepted this connection
	 */
